...
def Youtube_casts(url):
    ...
    st.error("Youtube is not supporting high resolution downloads through web although its showing 1080p downloads. \nTo download in high resolution you have to use our desktop app [click here](https://drive.google.com/file/d/1YrfxPCaXbkq_lYmPIpNdUO3YTnj9hMED/view?usp=sharing)")
